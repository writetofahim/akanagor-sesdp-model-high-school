            ...
            <div className=" md:ml-2 mb-3 justify-center lg:w-[35%] w-full">
              ...
              <div className="border dark:border-gray-700 rounded p-4">
                ...
                <p className="  pb2">
                  ...
                  that empowers students to thrive academically, personally, and
                  socially. As we celebrate each passing year, we are humbled by
                  the achievements of our students and the contributions they
                  make to society.
                </p>
              </div>
            </div>
