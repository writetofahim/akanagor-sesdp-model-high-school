...
import schoolImg_1 from "../../assets/images/school/school_1.jpg";
...
const Home = () => {
  ...
  return (
    <div>
      <div className="px-5 max-w-[1200px] w-full mx-auto mt-16 dark:text-white">
        <div className="space-y-3">
          ...
          <section className="relative overflow-hidden flex bg-white dark:bg-gray-800">
            ...
            <div class="container">
              <marquee class="text-lg items-center flex">
                Breaking News: Lorem ipsum dolor sit amet, consectetur Lorem
                ipsum dolor sit ametBreaking News: Lorem ipsum dolor sit amet,
              ...
              <div className="lg:w-1/2 lg:border dark:border-gray-700 lg:p-5 lg:space-y-3 ">
                ...
                <div className="text-center">
                  ...
                  <p className="mb-2 text-justify dark:text-gray-400">
                    ...
                    similique, voluptatibus ratione corporis aperiam atque
                    reiciendis, cum sit? Nesciunt non dolore, placeat officiis
                    iusto sed.
                  </p>
                </div>
              </div>
          ...
          <section className="w-full lg:flex justify-evenly">
            ...
            <div className="flex justify-center lg:w-[30%] w-full mt-3">
              <Calendar />
            </div>
          </section>
        </div>
