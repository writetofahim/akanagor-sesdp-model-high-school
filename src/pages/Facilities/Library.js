  ...
  return (
    <div className="lg:w-[75%] w-ful lg:mt-0 mt-5">
      <div className="w-full">
        <img
          className="w-full"
          src="https://www.cambrian.edu.bd/fontend-assets/images/library/L1.jpg"
          alt=""
        />
      ...
      <div className="mb-10">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-2">
          <img
            className="w-full"
            src="https://www.cambrian.edu.bd/fontend-assets/images/library/laibrary-gallery-05.jpg"
            alt=""
          />
          <img
            className="w-full"
            src="https://www.cambrian.edu.bd/fontend-assets/images/library/laibrary-gallery-01.jpg"
            alt=""
          />
          <img
            className="w-full"
            src="https://www.cambrian.edu.bd/fontend-assets/images/library/laibrary-gallery-02.jpg"
            alt=""
          />
        </div>
      </div>
