  ...
  return (
    <div className="px-5 h-[calc(100vh-64px)] mt-20">
      ...
      <div className={`h-full `}>
        <DropboxChooser
          appKey="rlrfoqersctu9jp"
          success={handleSuccess}
          cancel={() => console.log("Dropbox chooser canceled")}
          multiselect={true}
          //   extensions={[".pdf"]} // You can customize the allowed extensions
        >
          <button>Choose PDF Files from Dropbox</button>
        </DropboxChooser>
        {/* Display the selected file in an iframe */}
